...
- **Link komutları:** `show-config.json > chatLinks` içindeki her komut (`!site`, `!kutuphane`, `!twitch`, `!kick`…) sohbette o metni yazar, komut başına 30 sn'de bir. `!discord`, `!youtube`, `!instagram` boş bırakıldı; adresi yazınca çalışır.
