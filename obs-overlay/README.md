...
- **Mini oyunlar** (oyun sahnesinin üst ortasındaki etkinlik şeridinde görünür):
  ...
  - **🏅 Sezon:** Ganimet her ay sıfırdan başlayan bir sezon sıralamasında da toplanır (tüm zamanlar sıralaması ayrıca kalır). `!sezon` ilk üçü ve kişinin bu ayki ganimetini söyler; kumandada sezon listesi, Discord özetinde sezon lideri.
