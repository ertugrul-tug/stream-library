...
- **🎲 !öner:** Kaptanın oyun kütüphanesinden (`steam-library.json`) rastgele bir oyun ve Steam linkini önerir; 30 sn'de bir. Sonraki 1 dakikada 🔥 yazan her kişi bir oy sayılır; oy alan oyunlar kumandada "Son yayınlar > Sohbetin istediği oyunlar" listesinde birikir (en fazla 10, ✕ ile silinir).
