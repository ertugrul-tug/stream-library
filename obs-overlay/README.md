...
- **📅 !program:** Haftalık yayın saatini ve sıradaki seferi (24 saatten azsa kalan süreyle) söyler. Varsayılan Pazartesi–Cuma 20:30; değiştirmek için `show-config.json` içine `"weekly": {"days": [0,1,2,3,4], "time": "20:30"}` (0 = Pazartesi).
